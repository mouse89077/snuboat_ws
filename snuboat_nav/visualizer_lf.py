...
class Visualizer(Node):
    ...
    #subscribe from imu
        ...
        self.viz_des_heading_pub = self.create_publisher(Marker, "/viz_lf/des_heading", 1)
        self.viz_ref_heading_pub = self.create_publisher(Marker,"/viz_lf/ref_heading",1)
        ...
        self.viz_obs_phi_pub = self.create_publisher(MarkerArray, "/viz_lf/obs/phi", 1)
        self.obs_phi = []
        self.obs_r=[]
        self.des_heading = 0
        self.ref_heading=0
